...
import {foodNames, allLikeCount, allDislikeCount, allCount, dayLikeCount, dayDislikeCount} from "@/comm/data"
...
export default {
  ...
  data() {
    return {
      ...
      allNames: [],
      showList: false,
      host_addr: "http://192.168.5.79:8888",
      showLoading: false,
    };
  },
  methods: {
    ...
    initFoodLikeDislike() {
      ...
      //     })
      //   );
      this.allLikeCnt = allLikeCount()
      this.allDislikeCnt = allDislikeCount()
      this.allCnt = allCount()
